package net.ghostrealms.kingdoms.main;
...
import net.ghostrealms.kingdoms.cmds.KingdomsAdminCommand;
import net.ghostrealms.kingdoms.cmds.ResidentCommand;

import com.imdeity.deityapi.DeityAPI;
import com.imdeity.deityapi.api.DeityPlugin;

import net.ghostrealms.kingdoms.cmds.KingdomCommand;
import net.ghostrealms.kingdoms.cmds.KingdomsCommand;
import net.ghostrealms.kingdoms.cmds.PlotCommand;
import net.ghostrealms.kingdoms.cmds.TownCommand;
import net.ghostrealms.kingdoms.cmds.kingdom.KingdomChatCommand;
import net.ghostrealms.kingdoms.cmds.town.TownChatCommand;
import net.ghostrealms.kingdoms.listener.KingdomsPlayerListener;
