...
import net.ghostrealms.kingdoms.cmds.kingdoms.KingdomsInfoCommand;
import net.ghostrealms.kingdoms.cmds.kingdoms.KingdomsMapCommand;
import net.ghostrealms.kingdoms.cmds.kingdoms.KingdomsPricesCommand;
