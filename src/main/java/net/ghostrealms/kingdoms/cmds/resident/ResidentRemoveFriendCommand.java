...
public class ResidentRemoveFriendCommand extends DeityCommandReceiver {
    ...
    public boolean onPlayerRunCommand(Player player, String[] args) {
        if (args.length == 1) {
            ...
            if (friend != null) {
                ...
                KingdomsMain.plugin.chat.sendPlayerMessage(player, String.format(KingdomsMessageHelper.CMD_RES_REMOVE_FRIEND_PLAYER, friend.getName()));
            } else {
